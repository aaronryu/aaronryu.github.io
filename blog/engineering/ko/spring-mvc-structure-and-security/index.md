...
image: { url: ./spring-mvc-abstract.png, alt: "Spring MVC Abstract" }
keywords: Spring MVC, DispatcherServlet, Servlet Container, Spring Container, Filter, Interceptor, 웹 서버, WAS
description: Web Server에서 WAS로의 발전 과정과 함께 Spring MVC의 핵심인 DispatcherServlet의 동작 원리, 그리고 Filter와 Interceptor의 차이 및 처리 흐름을 상세히 설명합니다.
---
...
![Static Page from Web Server](./static-web-page-example.png)
...
![Web Server](./web-server-description.png)
...
![Web Server](./servlet-container-life-cycle.png)

## 예) Tomcat 의 요청/처리 흐름

**웹 어플리케이션**의 예로 **tomcat** 에서는 유저 요청을 아래의 과정으로 처리한다.

![Web Application](./web-application-description.png)
...
![Spring Web Application - 1. Init](./spring-web-application-description-1-init.png)
...
![Spring Web Application - 2. Request](./spring-web-application-description-2-request.png)
...
![Spring Web Application - 3. Filter and Interceptor](./spring-web-application-description-3-filter-and-interceptor.png)
...
![Spring Filters and Interceptors](./order-of-filters-and-interceptors.png)

간략하게 요약하면 아래 그림/흐름과 같다.

![Spring Filters and Interceptors - Summary](./summary-order-of-filters-and-interceptors.png)
