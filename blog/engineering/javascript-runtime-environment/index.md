...
image: { url: ./browser-and-nodejs.png, alt: "Difference between browser and nodejs" }
keywords: 자바스크립트 런타임, V8 엔진, Node.js, 웹 브라우저, Web API, libuv, 비동기 프로그래밍, 이벤트 루프
description: V8 엔진을 공유하는 크롬 브라우저와 Node.js의 공통점 및 차이점을 분석하고, Web API와 libuv를 통한 각 환경의 비동기 처리 구조를 상세히 설명합니다.
---
...
<b>브라우저 (프론트엔드)</b>와 **Node.js (백엔드)** 순서대로 구성상 어떤 공통점과 차이점이 있는지 간략하게만 알아보자.
...
![Browser consist of javascript engine and Web APIs](./browser-apis-different-implementation.png)
...
![Browser APIs has different implementation by browser](./browser-javascript-runtime-environment.png)
...
![Node.js system diagram](./node-js-system-diagram.jpeg)
